...
contract StdChainsTest is Test {
    function test_ChainRpcInitialization() public {
        ...
        assertEq(getChain(1).rpcUrl, "https://eth-mainnet.alchemyapi.io/v2/REDACTED_ALCHEMY_KEY");
        ...
        assertEq(getChain("mainnet").rpcUrl, "https://eth-mainnet.alchemyapi.io/v2/REDACTED_ALCHEMY_KEY");

        // Other RPCs should remain unchanged.
        assertEq(getChain(31337).rpcUrl, "http://127.0.0.1:8545");
        assertEq(getChain("sepolia").rpcUrl, "https://sepolia.infura.io/v3/REDACTED_INFURA_KEY");
    }
