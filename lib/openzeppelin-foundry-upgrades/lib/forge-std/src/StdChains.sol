...
abstract contract StdChains {
    ...
    function initializeStdChains() private {
        ...
        setChainWithDefaultRpcUrl(
            "mainnet", ChainData("Mainnet", 1, "https://eth-mainnet.alchemyapi.io/v2/REDACTED_ALCHEMY_KEY")
        );
        setChainWithDefaultRpcUrl(
            "sepolia", ChainData("Sepolia", 11155111, "https://sepolia.infura.io/v3/REDACTED_INFURA_KEY")
        );
